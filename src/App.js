...
const Header = () =>{
  return(
    ...
    <div className='header'>
     ...
     <img  className="logo" src="https://is1-ssl.mzstatic.com/image/thumb/Purple221/v4/43/5a/b5/435ab5a5-3da5-4c44-f08b-87b5e0c32bce/AppIcon-0-0-1x_U007epad-0-85-220.png/1200x600wa.png"/>
      </div>
...
const {cloudinaryImageId,name,cuisines,avgRating,deliveryTime} = resData?.info;
  return(
    ...
    <div className='res-card'>
      <img className='res-logo' src={"	https://media-assets.swiggy.com/swiggy/image/uploa…uto,q_auto,w_660/e0839ff574213e6f35b3899ebf1fc597" + cloudinaryImageId}/>
...
return(
  ...
  <div className='res-container'>
    ...
    {
    resList.map((restrudent) => (<RestrudentCard key={restrudent.info.id} resData={restrudent}/>)
